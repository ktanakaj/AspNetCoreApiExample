...
public class AccessLogMiddleware
{
    ...
    {
        return headers.TryGetValue("User-Agent", out var value) ? value.First() ?? string.Empty : string.Empty;
    }
    ...
    {
        return headers.TryGetValue("Referer", out var value) ? value.First() ?? string.Empty : string.Empty;
    }
